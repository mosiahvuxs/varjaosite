...
public class MidiaDAO {
	...
	public List<Midia> pesquisar(MidiaEnvio model) {
		...
		sql.append(" GROUP BY IMP.NUMERO_PAGINA, AU.DURACAO, VI.DURACAO, M.ID, AU.ARQUIVO, VI.ARQUIVO, IMP.ARQUIVO, W.ARQUIVO, M.TITULO, M.CHAMADA, A.ID, A.DESCRICAO, M.TIPO_MIDIA_ID, TM.DESCRICAO, M.DATA, IMP.CONTEUDO, W.CONTEUDO, W.URL,S.DESCRICAO, V.DESCRICAO  ORDER BY M.DATA DESC");
